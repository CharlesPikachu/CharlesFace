...
if __name__ != '__main__':
	from .standard_utils import convert2cpu
else:
	from standard_utils import convert2cpu
...
def print_cfg(blocks):
	...
	for block in blocks:
		...
		if block['type'] == 'net':
			...
			# Problem:
			# 	Here should assert width、height and filiters?
			out_widths.append(prev_width)
			out_heights.append(prev_height)
			out_filters.append(prev_filters)
...
if __name__ == '__main__':
	import sys
	path = sys.path[0][0:-6] + '/cfg/me/darknet19_wfc_face.cfg'
	print_cfg(parse_cfg(path))